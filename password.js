...
function generatePassword()
{
	...
	password = password.slice(0, uppercaseIndex) + uppercaseLetters.charAt(getRandomIndex(0, uppercaseLetters.length)) +
		password.slice(uppercaseIndex);

	// Insert dashes at specific positions
	password = password.slice(0, 6) + "-" + password.slice(6, 12) + "-" + password.slice(12, 19);
